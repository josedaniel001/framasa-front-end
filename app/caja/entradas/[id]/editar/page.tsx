...
import { Loader2, ArrowLeft, Save, TrendingUp } from "lucide-react"
...
export default function EditarEntradaCajaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Actualizando entrada de caja:", entradaData)
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <div className={`text-lg font-bold ${parseFloat(formData.monto) !== movimiento.monto ? 'text-blue-600' : 'text-green-600'}`}>
