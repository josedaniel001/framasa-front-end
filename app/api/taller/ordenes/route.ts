...
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${DJANGO_API_BASE}/api/taller/ordenes/${queryString ? `?${queryString}` : ""}`
    ...
    console.error("Error en GET /api/taller/ordenes:", error)
...
export async function POST(request: NextRequest) {
  try {
    ...
    const url = `${DJANGO_API_BASE}/api/taller/ordenes/`
    ...
    console.error("Error en POST /api/taller/ordenes:", error)
