...
/**
 * GET /api/bloquera/productos/stats
 * Obtiene estadísticas de productos de bloquera desde Django
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${DJANGO_API_URL}/api/bloquera/productos/stats/`, {
      method: 'GET',
      headers: {
    ...
    console.error('Error al obtener estadísticas de productos de bloquera:', error)
    return NextResponse.json(
