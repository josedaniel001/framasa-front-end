...
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${DJANGO_API_BASE}/api/planillas/nominas-detalle/${queryString ? `?${queryString}` : ""}`
    ...
    console.error("Error en API nominas-detalle:", error)
    return NextResponse.json(
